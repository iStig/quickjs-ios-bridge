...
WOSAI.web = {
  ...
  callSync: (param) => {
    console.log(">>>WOSAI.web.callSync: " + JSON.stringify(param));
      console.log(">>>WOSAI.web.callSync: " + param);
    ...
    console.log(">>>WOSAI.web.callSync_callSync: " + JSON.stringify(res));
  ...
  callAsync: (param, callback) => {
    ...
    console.log(">>>WOSAI.web.callAsyncWithParam_genCallArgv: " + JSON.stringify(params));
    let res = _call(JSON.stringify(params));
    console.log(">>>WOSAI.web.callAsyncWithParam_call: " + JSON.stringify(res));
